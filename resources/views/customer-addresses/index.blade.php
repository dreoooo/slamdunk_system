...
@section('page-title', 'Customer Addresses Dashboard')

@section('content')
    <div class="p-6 bg-white rounded-lg shadow-md">

        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold">All Customer Addresses</h2>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($addresses as $addr)
                        <tr>
                            ...
                            <td class="px-4 py-2">
                                {{ $addr->customer?->first_name ?? '-' }}
                                {{ $addr->customer?->last_name ?? '' }}
                            </td>
                            ...
                            <td class="px-4 py-2 flex space-x-4">
                                ...
                                <a href="{{ route('customer-addresses.edit', $addr->id) }}"
                                ...
                                {{-- Delete Icon --}}
                                <form action="{{ route('customer-addresses.destroy', $addr->id) }}" method="POST"
